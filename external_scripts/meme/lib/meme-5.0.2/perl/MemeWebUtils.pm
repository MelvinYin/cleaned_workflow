...
use lib qw(/home/melvin/meme/lib/meme-5.0.2/perl);
...
unless ($@) {
  Log::Log4perl::init('/home/melvin/meme/share/meme-5.0.2/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.service.utils');
}

my $service_invocation_log_dir = '/home/melvin/meme/var/meme-5.0.2/LOGS';
my $tmpdir = '';
...
sub update_status {
  ...
  my $template = HTML::Template->new(filename => '/home/melvin/meme/share/meme-5.0.2/job_status.tmpl');
